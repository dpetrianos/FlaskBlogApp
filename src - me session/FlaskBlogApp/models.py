...
class User(db.Model):
    ...
    # fetch articles of the user , 
    #  
    # when want to print some info from this class (repr=represent)
    def __repr__(self):
...
class Article(db.Model):
    ...
    date_created = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
                # datetime.utcnow() gives the current date
                # datetime.utcnow gives the method to sqlalchemy to save it into db
